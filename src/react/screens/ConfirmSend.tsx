...
export function ConfirmSend({ senderAmount, recipientHandle, recipientAmount, walletAddress, network, transactionFeeLabel = "Free $0.00", onBack, onConfirm }: ConfirmSendProps) {
  return (
    <div style={{ ...screenCardStyle, fontFamily: "Helvetica, Arial, sans-serif", background: "#EEF0F2", borderRadius: 24, padding: 20, color: "#111827", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ fontSize: 24, fontWeight: 800, textAlign: "center", marginBottom: 20 }}>Confirm Send</div>

      <div style={{ display: "flex", flexDirection: "column", gap: 2, background: "#fff", borderRadius: 16, padding: 6, position: "relative" }}>
        <TransferPartyRow role="Send" partyName="From you" amount={senderAmount} />
        <div
          style={{
            width: 32,
            height: 32,
