...
export function PaymentOptionRow({ label, selected = false, radioColor = "var(--cosmos-radio, #D1D5DB)", badge, onSelect }: PaymentOptionRowProps) {
  return (
    <div
      onClick={onSelect}
      ...
      style={{
        ...
        padding: "20px 24px",
        border: "1px solid var(--cosmos-border, #E5E7EB)",
        borderRadius: 12,
        background: "var(--cosmos-panel, #fff)",
        gap: 16,
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <span style={{ fontSize: 15, color: "var(--cosmos-fg, #111827)", fontWeight: 600 }}>{label}</span>
      </div>
